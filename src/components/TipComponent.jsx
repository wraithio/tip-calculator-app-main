...
const TipComponent = () => {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("TipPercent", 0) != "" || people != 0) {
      generateResult(localStorage.getItem("TipPercent", 0), null);
    }
  ...
  return (
    <div className="min-h-screen flex justify-center place-items-center">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-row gap-10 bg-white py-6 px-8 rounded-xl max-w-25 drop-shadow-xl">
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="grid grid-rows-2 grid-cols-3 gap-2">
                ...
                >
                  <h2 className="text-lg py-1">5%</h2>
                </button>
                <button
                  id="TipBtn10"
                  className="text-white bg-[#00494d] rounded-[.25rem] hover:text-[#00494d] hover:bg-[#9fe8df]"
                ...
                >
                  <h2 className="text-lg py-1">10%</h2>
                </button>
                <button
                  id="TipBtn15"
                  className="text-white bg-[#00494d] rounded-[.25rem] hover:text-[#00494d] hover:bg-[#9fe8df]"
                ...
                >
                  <h2 className="text-lg py-1">15%</h2>
                </button>
                <button
                  id="TipBtn25"
                  className="text-white bg-[#00494d] rounded-[.25rem] hover:text-[#00494d] hover:bg-[#9fe8df]"
                ...
                >
                  <h2 className="text-lg py-1">25%</h2>
                </button>
                <button
                  id="TipBtn50"
                  className="text-white bg-[#00494d] rounded-[.25rem] hover:text-[#00494d] hover:bg-[#9fe8df]"
                ...
                >
                  <h2 className="text-lg py-1">50%</h2>
                </button>
                <button
          ...
          <div className="bg-[#00494d] rounded-lg flex flex-col gap-4 px-8 pb-6 pt-8">
            <div className="flex gap-8 justify-between">
              <div>
                <h3 className="text-white">Tip Amount</h3>
                <h3 className="gray-cyan">/ person</h3>
              </div>
              <div className="flex place-items-center text-[#26c0ab] text-4xl">
                <h1>
                  <b>${tip}</b>
                </h1>
              </div>
